...
import com.example.nutrahelp.data.*
import kotlinx.coroutines.flow.SharingStarted
import kotlinx.coroutines.flow.stateIn
import kotlinx.coroutines.launch

class SleepViewModel(app: Application, private val dao: SleepDao) : AndroidViewModel(app) {
    constructor(app: Application) : this(app, NutraHelpDatabase.getInstance(app).sleepDao())
    val entries = dao.getAll().stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), emptyList())
    fun insert(entry: SleepEntryEntity) = viewModelScope.launch { dao.insert(entry) }
    fun delete(entry: SleepEntryEntity) = viewModelScope.launch { dao.delete(entry) }
    fun deleteAll() = viewModelScope.launch { dao.deleteAll() }
}

class MoodViewModel(app: Application, private val dao: MoodDao) : AndroidViewModel(app) {
...
class EnergyViewModel(app: Application, private val dao: EnergyDao) : AndroidViewModel(app) {
...
class GutViewModel(app: Application, private val dao: GutDao) : AndroidViewModel(app) {
...
class InflammationViewModel(app: Application, private val dao: InflammationDao) : AndroidViewModel(app) {
...
class SensitivityViewModel(app: Application, private val dao: SensitivityDao) : AndroidViewModel(app) {
...
class BloodSugarViewModel(app: Application, private val dao: BloodSugarDao) : AndroidViewModel(app) {
...
class BpViewModel(app: Application, private val dao: BpDao) : AndroidViewModel(app) {
...
class StressViewModel(app: Application, private val dao: StressDao) : AndroidViewModel(app) {
...
class ExerciseViewModel(app: Application, private val dao: ExerciseDao) : AndroidViewModel(app) {
...
class MeasurementViewModel(app: Application, private val dao: MeasurementDao) : AndroidViewModel(app) {
...
class CholesterolViewModel(app: Application, private val dao: CholesterolDao) : AndroidViewModel(app) {
...
class HeartRateViewModel(app: Application, private val dao: HeartRateDao) : AndroidViewModel(app) {
...
class A1CViewModel(app: Application, private val dao: A1CDao) : AndroidViewModel(app) {
...
class StepViewModel(app: Application, private val dao: StepDao) : AndroidViewModel(app) {
...
class BodyFatViewModel(app: Application, private val dao: BodyFatDao) : AndroidViewModel(app) {
...
class FiberViewModel(app: Application, private val dao: FiberDao) : AndroidViewModel(app) {
...
class AlcoholViewModel(app: Application, private val dao: AlcoholDao) : AndroidViewModel(app) {
...
class CaffeineViewModel(app: Application, private val dao: CaffeineDao) : AndroidViewModel(app) {
...
class SugarViewModel(app: Application, private val dao: SugarDao) : AndroidViewModel(app) {
...
class SodiumViewModel(app: Application, private val dao: SodiumDao) : AndroidViewModel(app) {
...
class MacroViewModel(app: Application, private val dao: MacroDao) : AndroidViewModel(app) {
...
class ProteinViewModel(app: Application, private val dao: ProteinDao) : AndroidViewModel(app) {
...
class CalorieViewModel(app: Application, private val dao: CalorieDao) : AndroidViewModel(app) {
...
class NutrientViewModel(app: Application, private val dao: NutrientDao) : AndroidViewModel(app) {
...
class HungerViewModel(app: Application, private val dao: HungerDao) : AndroidViewModel(app) {
...
class MealTimingViewModel(app: Application, private val dao: MealTimingDao) : AndroidViewModel(app) {
...
class MindfulMealViewModel(app: Application, private val dao: MindfulMealDao) : AndroidViewModel(app) {
...
class MilestoneViewModel(app: Application, private val dao: MilestoneDao) : AndroidViewModel(app) {
...
class NsvViewModel(app: Application, private val dao: NsvDao) : AndroidViewModel(app) {
...
class SideEffectViewModel(app: Application, private val dao: SideEffectDao) : AndroidViewModel(app) {
...
class LabViewModel(app: Application, private val dao: LabDao) : AndroidViewModel(app) {
...
class JournalViewModel(app: Application, private val dao: JournalDao) : AndroidViewModel(app) {
...
class CheckInViewModel(app: Application, private val dao: CheckInDao) : AndroidViewModel(app) {
...
class Glp1ViewModel(app: Application, private val dao: Glp1Dao) : AndroidViewModel(app) {
